...
function activateEasterEgg() {
    ...
    const messages = [
        '¡ULTRA COMBO! 🎮<br><br>Modo Nutri-Gamer activado. ¡Todas las calorías cuentan doble de saludables! 💪',
        '¡ACHIEVEMENT! 🏆<br><br>"Maestro del Konami Code"<br><br>Fun fact: El brócoli tiene más proteína que el bistec... ¡por caloría! 🥦',
        '¡SECRETO! 🔓<br><br>Las zanahorias NO mejoran la visión nocturna. Fue propaganda británica 🥕',
        '¡LEGENDARY! ⭐<br><br>Easter egg encontrado. Ricardo está orgulloso de ti 😎',
        '¡COMBO x999! 🎊<br><br>El aguacate es una baya gigante 🥑<br><br>Tu mundo cambió.'
    ];
...
function createConfetti(count) {
    ...
    const colors = ['#34C759', '#007AFF', '#FF9500', '#FF3B30', '#5AC8FA', '#AF52DE'];
...
function getProgressColor(completed, total) {
    ...
    if (percentage <= 40) return '#FF3B30'; // Rojo
    if (percentage <= 60) return '#FF9500'; // Naranja
    return '#34C759'; // Verde
}
...
function renderPatientInfo() {
    ...
    // Macros
    document.getElementById('calories').textContent = patientData.calories || '0';
    document.getElementById('protein').textContent = (patientData.protein || '0') + 'g';
    document.getElementById('carbs').textContent = (patientData.carbs || '0') + 'g';
    document.getElementById('fats').textContent = (patientData.fats || '0') + 'g';
}
...
function getMealsForDay(day) {
    ...
    if (dayMeals) {
        return [
            ...
            { name: '🍽️ Comida', description: dayMeals.comida || 'No especificado' },
    ...
    return [
        ...
        { name: '🍽️ Comida', description: 'Pendiente de configurar' },
        { name: '🥤 Colación', description: 'Pendiente de configurar' },
...
function updateDayProgress(dayData) {
    ...
    const color = getProgressColor(completedMeals, 5);
