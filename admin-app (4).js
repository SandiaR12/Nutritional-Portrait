...
window.handleMealImageUpload = function(dayKey, mealKey, input) {
    ...
    reader.onload = function(e) {
        ...
        var preview = document.getElementById('img_preview_' + dayKey + '_' + mealKey);
        if (preview) { preview.src = b64; preview.style.display = 'block'; }
        var hidden = document.getElementById('img_data_' + dayKey + '_' + mealKey);
...
window.clearMealImage = function(dayKey, mealKey) {
    ...
    var input = document.getElementById('img_input_' + dayKey + '_' + mealKey);
